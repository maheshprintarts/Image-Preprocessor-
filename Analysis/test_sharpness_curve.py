...
def profile_image(path):
    ...
    try:
        scales = [1.0, 0.5, 0.4, 0.3, 0.2, 0.15, 0.10, 0.05]
        for scale in scales:
            ...
            print(f"Scale {scale*100:3.0f}% | Size: {new_w:4d}x{new_h:4d} | Sharpness (Laplacian Var): {s:7.2f}")
...
if __name__ == '__main__':
    profile_image('input_images/30782036-1.jpg')
